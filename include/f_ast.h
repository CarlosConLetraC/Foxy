...
/* ========================================================================= */
/* LISTA MAESTRA DE NODOS AST (FOXY_AST_NODE_LIST)                           */
/* Syntax: F(EnumNode)                                                       */
/* ========================================================================= */
#define FOXY_AST_NODE_LIST(F) \
    F(FOXY_AST_NODE_PROGRAM) \
    F(FOXY_AST_NODE_INCLUDE) \
    F(FOXY_AST_NODE_EXPR_STMT) \
    F(FOXY_AST_NODE_CALL) \
    F(FOXY_AST_NODE_LITERAL) \
    F(FOXY_AST_NODE_IDENTIFIER) \
    F(FOXY_AST_NODE_BLOCK) \
    F(FOXY_AST_NODE_BINARY_OP) \
    F(FOXY_AST_NODE_VAR_DECL) \
    F(FOXY_AST_NODE_ASSIGN) \
    F(FOXY_AST_NODE_IF) \
    F(FOXY_AST_NODE_WHILE) \
    F(FOXY_AST_NODE_RETURN) \
    F(FOXY_AST_NODE_FUNCTION) \
    F(FOXY_AST_NODE_FOR) \
    F(FOXY_AST_NODE_ENV) \
    F(FOXY_AST_NODE_ENV_CREATE) \
    F(FOXY_AST_NODE_ENV_BIND) \
    F(FOXY_AST_NODE_POPEN) \
    F(FOXY_AST_NODE_MEMBER_ACCESS) \
    F(FOXY_AST_NODE_INDEX_ACCESS)

typedef enum __attribute__((__packed__)) {
    #define F(node_type) node_type,
